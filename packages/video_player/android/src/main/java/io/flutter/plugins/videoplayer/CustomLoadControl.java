...
public class CustomLoadControl implements LoadControl {
     ...
     */
    static final int DEFAULT_MIN_BUFFER_MS = 5000;

    /**
     * The default maximum duration of media that the player will attempt to buffer, in milliseconds.
     */
    static final int DEFAULT_MAX_BUFFER_MS = 20000;
     ...
     * action.
     */
    static final int DEFAULT_BUFFER_FOR_PLAYBACK_AFTER_REBUFFER_MS  = 2500;
     ...
     */
    static final int DEFAULT_TARGET_BUFFER_BYTES = C.LENGTH_UNSET;

    /** The default prioritization of buffer time constraints over size constraints. */
    static final boolean DEFAULT_PRIORITIZE_TIME_OVER_SIZE_THRESHOLDS = true;
